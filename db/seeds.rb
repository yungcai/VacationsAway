...
stay1 = Stay.create!(user_id:user1.id, price: 200.00, location:'Brooklyn, NY', lat:23.432432, long:-33.345424, description:'Beautiful 2BR stay in downtown Brooklyn')
...
stay5 = Stay.create!(user_id:user3.id, price: 149.00, location:'San Diego, CA', lat:23.432432, long:-23.342324, description:'1BR close to the beach')
...
stay3.photo.attach(io: open('https://vacationsaway-aa-dev.<your_region>.amazonaws.com/<optional_folder_name>/<some_file>.jpg'))